document.addEventListener('DOMContentLoaded', () => {
    ...
    const historyData = window.EventFlow ? window.EventFlow.getCoachHistory() : [];
    ...
    function renderHistory(data) {
        ...
        if (data.length === 0) {
            container.innerHTML = `<div style="text-align: center; grid-column: 1/-1; padding: 60px 20px;"><p style="color: #94a3b8;">No events found matching your criteria.</p></div>`;
            return;
        }
